...
export default function Bots() {
  ...
  // mientras el otro se acomoda en eje Y. El título queda QUIETO (solo se
  // mueven las tarjetas).
      ...
      <div className="mx-auto w-full max-w-6xl px-6 py-6 sm:px-10 lg:px-8">
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
          ...
          <Reveal direction="left">
            <article className="group relative flex h-full flex-col overflow-hidden rounded-2xl border border-line bg-card p-4 transition-all duration-500 hover:border-emerald-400/40 hover:shadow-[0_0_40px_rgba(37,211,102,0.12)] sm:p-5">
              ...
              <div className="mb-3 flex items-center justify-between">
                <div className="flex h-10 w-10 items-center justify-center rounded-xl border border-emerald-400/25 bg-emerald-400/10 text-emerald-400 transition-shadow duration-500 group-hover:shadow-[0_0_28px_rgba(37,211,102,0.35)]">
              ...
              <ul className="mt-3 flex-1 space-y-1.5">
                {whatsapp.features.map((feature) => (
                  <li key={feature} className="flex items-start gap-2.5 text-[13px] leading-snug text-muted sm:text-sm">
              ...
              <Magnetic strength={0.16} className="mt-4">
                <a
                  href={whatsapp.ctaUrl}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group/btn flex w-full items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-[#25D366] to-[#128C7E] px-5 py-3 text-sm font-semibold text-white transition-all duration-300 hover:brightness-110 hover:shadow-[0_0_36px_rgba(37,211,102,0.45)]"
                >
          ...
          <Reveal direction="right" delay={0.12}>
            <article className="group relative flex h-full flex-col overflow-hidden rounded-2xl border border-line bg-card p-4 transition-all duration-500 hover:border-fuchsia-400/40 hover:shadow-[0_0_40px_rgba(214,41,118,0.14)] sm:p-5">
              ...
              <div className="mb-3 flex items-center justify-between">
                <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-[#feda75] via-[#d62976] to-[#962fbf] shadow-lg shadow-fuchsia-500/20 transition-transform duration-500 group-hover:scale-110">
              ...
              <Magnetic strength={0.16} className="mt-4">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group/btn flex w-full items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-[#feda75] via-[#d62976] to-[#962fbf] px-5 py-3 text-sm font-semibold text-white transition-all duration-300 hover:brightness-110 hover:shadow-[0_0_36px_rgba(214,41,118,0.5)]"
                >
